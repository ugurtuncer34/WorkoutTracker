...
namespace WorkoutTracker.Data
{
    public static class DbInitializer
    {
        public static void Initialize(AppDbContext context)
        {
            ...
            var glutes = new TargetMuscle { Name = "Glutes", IconKey = "ic_glutes", MuscleGroupId = legs.Id };
            ...
            var exercises = new[]
            {
                ...
                new Exercise { Name = "Push-Up", IconKey = "ic_push_up", TargetMuscleId = pectorals.Id },

                new Exercise { Name = "Bent-Over Row", IconKey = "ic_bent_over_row", TargetMuscleId = lats.Id },
                ...
                new Exercise { Name = "Squat", IconKey = "ic_squat", TargetMuscleId = quadriceps.Id },
                new Exercise { Name = "Romanian Deadlift", IconKey = "ic_romanian_deadlift", TargetMuscleId = hamstrings.Id },
                new Exercise { Name = "Glute Bridge", IconKey = "ic_glute_bridge", TargetMuscleId = glutes.Id },

                new Exercise { Name = "Forearm Plank", IconKey = "ic_forearm_plank", TargetMuscleId = abs.Id }
            };
